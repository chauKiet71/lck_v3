...
const Insights: React.FC = () => {
  ...
  return (
    <section className="py-32 px-6 lg:px-12 bg-white dark:bg-navy-deep transition-colors" id="insights">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {featuredInsights.map((insight) => {
            ...
            return (
              <Link href={`/insight/${insight.id}`} key={insight.id} className="group cursor-pointer block">
